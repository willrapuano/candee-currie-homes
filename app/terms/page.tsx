    ...
    <div className="pt-20">
      ...
      <section className="section-padding bg-white">
        <div className="container-lg prose prose-navy max-w-none">
          ...
          <p className="text-charcoal-muted leading-relaxed mb-4">
            Property information on this site is offered for general informational purposes only and is
            subject to change without notice. Buyers and sellers should independently verify any pricing,
            availability, square footage, school information, or other property details before making decisions.
          </p>
